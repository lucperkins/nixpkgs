...
let
  # https://github.com/paradedb/paradedb/blob/v0.21.5/Cargo.lock#L3307
...
buildPgrxExtension (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-H0w2r9qCC23y2mHQ6+cWarRBtttFnxNj/SCakDr3BIY=";
  };

  cargoHash = "sha256-jgWIOu2sw/i2c1EPbvZygJ92cCpBV57K7pXvPA+rjKo=";
  ...
  # https://github.com/paradedb/paradedb/blob/v0.21.5/Cargo.toml#L38-L39
  cargo-pgrx = cargo-pgrx_0_16_1;

  # https://github.com/paradedb/paradedb/tree/v0.21.5/pg_search
  cargoPgrxFlags = [
    "--package"
    "pg_search"
  ];
  ...
  meta = {
    ...
    # https://github.com/paradedb/paradedb/blob/v0.21.5/pg_search/Cargo.toml#L14-L18
